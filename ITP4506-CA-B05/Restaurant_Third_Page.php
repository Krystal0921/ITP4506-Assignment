    ...
    <div class="fieldset-container">
        <center>
            <table>
                ...
                <tbody>
                    <?php
                        $restaurant_orders_list_array = restaurant_orders_history_list($user->user_ID);
                    ...
                    <tr>
                        ...
                        <form action="Restaurant_Third_Page_Message.php">
                            <td><button type="submit" class="message">Message</button></td>
                        </form>
